...
var optInteractive = addOption("--interactive", "Show an interactive scene you can move around in", false);
...
camera.SetPosition(lookFrom: P3(13, 2, 3), lookAt: P3(0, 0, 0), vUp: P3(0, 1, 0), vFov: 20,
    aspectRatio: Round((float)imageWidth / imageHeight, 1), aperture: 0.1f, focusDist: 10.0f);
...
if (interactive)
{
    Interactive.RunInteractive(imageWidth, imageHeight, camera, world, maxDepth, numThreads, samplesPerPixel);
    return 0;
}
